					...
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget">
								...
								<div class="content">
									<ul>
										<li>Sub Total<span>Rp. <?= number_format($this->cart->total(),0,',','.'); ?></span></li>
										<li>(+) Ongkos Kirim<span>Rp. -</span></li>
										<li class="last">Total<span>Rp. <?= number_format($this->cart->total(),0,',','.'); ?></span></li>
									</ul>
								</div>
							</div>
							<!--/ End Order Widget -->
							...
							<div class="single-widget payement">
								<div class="content">
									<img src="<?=base_url('assets/images/payment-method.png')?>"> alt="#">
								</div>
							</div>
							...
							<div class="single-widget get-button">
								<div class="content">
									<div class="button">
										<a href="<?=base_url('Home_Controller/proses_order')?>" class="btn">proceed to checkout</a>
									</div>
								</div>
							</div>
							<!--/ End Button Widget -->
				...
				<div class="container">
					<div class="inner">
						<div class="row">
							...
							<div class="col-lg-6 col-12">
								<div class="right">
									<img src="<?=base_url('assets/images/payments.png')?>"> alt="#">
								</div>
							</div>
						</div>
					</div>
